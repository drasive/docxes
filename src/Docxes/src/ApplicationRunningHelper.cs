...
/// <remarks>Source: http://blog.billsdon.com/2011/10/c-sharp-check-if-application-is-already-running-then-set-focus/</remarks>
/// -------------------------------------------------------------------------------------------------
internal static class ApplicationRunningHelper {
    ...
    /// -------------------------------------------------------------------------------------------------
    internal static bool CheckAlreadyRunning() {
        /*
        const int SW_HIDE = 0;
